...
if(isset($_POST['felhasznalo']) && isset($_POST['jelszo']) && isset($_POST['vezeteknev']) && isset($_POST['utonev'])) {
    try {
        ...
        $sqlSelect = "select id from regfelhasznalok where bejelentkezes = :bejelentkezes";
        ...
        if($row = $sth->fetch(PDO::FETCH_ASSOC)) {
            ...
            $sqlInsert = "insert into regfelhasznalok(id, csaladi_nev, uto_nev, bejelentkezes, jelszo)
